...
void setup() {
  ...
  MsgPacketizer::subscribe(LoRa, 0x0A,
      ...
      )
    {
      ...
      Serial.print((float)flightTime / 1000.0); Serial.print(",");
      ...
      Serial.print((float)height / 10.0); Serial.print(",");
      Serial.print((float)speed / 10.0); Serial.print(",");
      Serial.print((float)accuracy / 10.0); Serial.print(",");

      Serial.print((float)motorTemperature / 100.0); Serial.print(",");
      Serial.print((float)mcuTemperature / 100.0); Serial.print(",");
      Serial.print((float)inputVoltage / 1000.0); Serial.print(",");
      Serial.print((float)currentPosition / 100.0); Serial.print(",");
